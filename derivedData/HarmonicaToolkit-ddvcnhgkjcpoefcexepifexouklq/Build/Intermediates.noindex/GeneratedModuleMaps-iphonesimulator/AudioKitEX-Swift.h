...
#ifndef AUDIOKITEX_SWIFT_H
#define AUDIOKITEX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AudioKitEX",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10AudioKitEX10AudioKitAU")
@interface AudioKitAU : AUAudioUnit
@property (nonatomic, readonly, copy) NSArray<NSNumber *> * _Nullable channelCapabilities;
